...
<form action="${pageContext.request.contextPath}/product/editproduct?id=<%=product.getId()%>" method="post">
    ...
    <label><input name="price" placeholder="цена" type="number" value="<%=product.getPrice()%>"></label> <br/>
    <label><input name="discount" placeholder="скидка" type="number" value="<%=product.getDiscount()%>"></label> <br/>
