...
<h2>Добро пожаловать в Систему учета продуктов.
    Для работы с базой данных введите логи и пароль, либо войдите как гость (доступна возможность только просмотра) </h2>
...
<h4><a href="${pageContext.request.contextPath}/content" target="content">Зайти как ГОСТЬ</a></h4>
<br>
<br>
